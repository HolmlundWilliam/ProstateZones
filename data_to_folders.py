...
parser.add_argument('--images', type=str, default=['T2_Ax','T2_Sag','T2_Cor','DWI','ADC','HBV'], nargs='+', help='List of strings for the image sequences you want to include. Options are: T2_Ax, T2_Sag, T2_Cor, DWI, ADC, and HBV.')
